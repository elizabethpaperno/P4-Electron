...
#c.execute("""CREATE TABLE IF NOT EXISTS retuarants(name TEXT, address TEXT, takeout BOOL, parking BOOL, cat LIST, hours DICT, reviews DICT, alcohol BOOL, mode TEXT, s_grade TEXT, vio TEXT, seating TEXT, diet LIST, u_reviews LIST)""")
